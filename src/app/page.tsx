      ...
      <div className="relative flex min-h-[80vh] flex-col items-center justify-center overflow-hidden bg-dark-brand p-5 text-light-brand">
        ...
        <div className="mt-10 space-y-5 md:space-y-10">
          ...
          <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
            <button className="cursor-pointer rounded-md bg-accent-brand/90 px-3 py-2 font-medium text-light-brand transition-all duration-200 ease-in hover:bg-accent-brand">
              See Our Gifts
            </button>
            <button className="cursor-pointer rounded-md border border-accent-brand bg-transparent px-3 py-2 font-medium text-light-brand transition-all duration-200 ease-in hover:bg-accent-brand">
